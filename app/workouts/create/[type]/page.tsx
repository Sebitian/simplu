...
export default function CreateWorkoutPage() {
  ...
  const [workoutSteps, setWorkoutSteps] = useState<WorkoutStep[]>([]); // Start with empty array
  ...
  const handleStepClick = (index: number) => {
    if (expandedStepIndex === index) {
      ...
      setFormData({
        ...
        [index]: {
          stepType: 'Exercise',
          exerciseName: workoutSteps[index].exercise_name || '', // Don't auto-select first exercise
          targetType: 'Reps',
